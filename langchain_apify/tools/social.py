"""Social-media Actor tools and their input schemas.

Each tool wraps a single Apify social-media Actor behind a simplified,
...
class ApifyInstagramScraperTool(_ApifyGenericTool):  # type: ignore[override]
    ...
    args_schema: ArgsSchema | None = ApifyInstagramScraperInput
...
class ApifyLinkedInProfilePostsTool(_ApifyGenericTool):  # type: ignore[override]
    ...
    args_schema: ArgsSchema | None = ApifyLinkedInProfilePostsInput
...
class ApifyLinkedInProfileSearchTool(_ApifyGenericTool):  # type: ignore[override]
    ...
    args_schema: ArgsSchema | None = ApifyLinkedInProfileSearchInput
...
class ApifyLinkedInProfileDetailTool(_ApifyGenericTool):  # type: ignore[override]
    ...
    args_schema: ArgsSchema | None = ApifyLinkedInProfileDetailInput
...
class ApifyTwitterScraperTool(_ApifyGenericTool):  # type: ignore[override]
    ...
    args_schema: ArgsSchema | None = ApifyTwitterScraperInput
...
class ApifyTikTokScraperTool(_ApifyGenericTool):  # type: ignore[override]
    ...
    args_schema: ArgsSchema | None = ApifyTikTokScraperInput
...
class ApifyFacebookPostsScraperTool(_ApifyGenericTool):  # type: ignore[override]
    ...
    args_schema: ArgsSchema | None = ApifyFacebookPostsScraperInput
